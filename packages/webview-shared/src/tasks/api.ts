...
import { defineCommand, defineNotification, defineRequest } from "../ipc/protocol";
...
export const getTaskDetails = defineRequest<{ taskId: string }, TaskDetails>("getTaskDetails");
...
export const sendTaskMessage = defineCommand<{ taskId: string; message: string }>("sendTaskMessage");
